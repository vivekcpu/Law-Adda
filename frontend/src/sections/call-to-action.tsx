    ...
    return (
        <section className="flex flex-col items-center justify-center max-w-7xl mx-auto my-42 px-4">
            <h3 className="font-domine text-3xl max-w-md text-center bg-linear-to-r from-gray-800 to-gray-500 bg-clip-text text-transparent">
                Your answers are just one upload away
            </h3>
            <p className="mt-4 text-sm/6 text-gray-500 max-w-md text-center">
                The information provided by LawAdda is generated using artificial intelligence and is intended for general informational purposes only. It should not be considered legal advice, nor does it create any lawyer-client relationship. Users are advised to consult a qualified legal professional before making any legal decisions..
            </p>
